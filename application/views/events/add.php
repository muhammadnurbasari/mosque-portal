                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="p-5">
                                                ...
                                                <form enctype="multipart/form-data" class="" method="post" action="<?php echo base_url('manage/events/add') ?>">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-3 mb-sm-0">
                                                            ...
                                                            <textarea name="content" id="content" class="form-control textarea" rows="7"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-3 mb-sm-0">
                                                    ...
                                                    <!-- <a href="#" class="btn btn-primary btn-user btn-block" id="btnSave" data-table="events">
                                                        Submit
                                                    </a> -->
